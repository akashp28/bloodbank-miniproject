  ...
  <?php include 'header.php'; ?>
        ...
        <div class="col-lg-4 col-md-5 col-sm-6 col-xs-7 mb-5">
          <div class="card rounded">
            <ul class="nav nav-tabs justify-content-center bg-light" style="padding: 20px">
              <li class="nav-item">
                <a class="nav-link active" data-toggle="tab" href="#hospitals"><b>Hospitals</b></a>
              </li>
              <li class="nav-item">
                <a class="nav-link" data-toggle="tab" href="#receivers"><b>User</b></a>
              </li>
            </ul>
    ...
    <div class="tab-content">
       ...
       <div class="tab-pane container active" id="hospitals">
        ...
        <form action="file/hospitalTReg.php" method="post" enctype="multipart/form-data">
          ...
          <input type="text" name="hregid" placeholder="Hospital Reg. ID" class="form-control mb-3" required>
       ...
       <div class="tab-pane container fade" id="receivers">
         ...
         <form action="file/receiverReg.php" method="post" enctype="multipart/form-data">
          ...
          <select name="trcard" class="form-control mb-3" required>
                <option disabled="" selected="">ID Type</option>
                <option value="aadhar">Aadhar Card</option>
                <option value="dl">Driving Licence</option>
                <option value="eid">Election Id</option>
          </select>
          <input type="text" name="trcardno" placeholder="ID Card No." class="form-control mb-3" required>
