...
<body>
  <?php require 'header.php'; ?>
    ...
    <div class="container cont">
     ...
     <li class="nav-item">
        <a class="nav-link" data-toggle="tab" href="#admin"><b> Admin</b></a>
     </li>
    </ul>
    ...
    <div class="tab-content">
      ...
      <div class="tab-pane container fade" id="admin">
         <form action="file/adminLogin.php" class="login-form" method="post">
          ...
          <input type="text" name="aemail" placeholder="User Name" class="form-control mb-4">
          <label class="text-muted font-weight-bold" class="text-muted font-weight-bold">Password</label>
          <input type="password" name="apassword" placeholder="Password" class="form-control mb-4">
